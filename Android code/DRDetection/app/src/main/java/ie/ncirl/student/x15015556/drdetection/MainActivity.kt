...
//        bindViews()
    ...
    fun buttons() {
        ...
        camera.setOnClickListener(View.OnClickListener { // Check if we have permission
...
//        val next = findViewById(R.id.next)
    ...
    fun getRealPathFromURI(contentUri: Uri?): String? {
        ...
        val cursor : Cursor? = CursorLoader(this, contentUri!!, proj, null, null, null).loadInBackground()
    ...
    fun makeToast(s: String?) {
        if (t != null) t?.cancel()
        t = Toast.makeText(null, s, Toast.LENGTH_LONG)
        t?.show()
    }
